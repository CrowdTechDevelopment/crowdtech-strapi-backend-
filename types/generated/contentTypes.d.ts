...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    contacts: Attribute.Relation<
      ...
      'api::contact.contact'
    >;
    credentials: Attribute.Relation<
      'api::project.project',
      'oneToMany',
      'api::credential.credential'
    >;
...
export interface ApiServerServer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    system: Attribute.Enumeration<
      ['windows 10', 'windows 7', 'ubuntu 20', 'ubuntu 22']
    >;
...
export interface ApiStrapiStrapi extends Schema.CollectionType {
  collectionName: 'strapis';
  info: {
    singularName: 'strapi';
    pluralName: 'strapis';
    displayName: 'Strapi';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::strapi.strapi': ApiStrapiStrapi;
